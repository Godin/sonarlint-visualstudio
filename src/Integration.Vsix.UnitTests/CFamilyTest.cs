    ...
    public class CFamilyTest
    {
        ...
        public void FileConfig_Test1()
        {
            CFamily.Capture[] captures = new CFamily.FileConfig()
            {
                ...
                AbsoluteFilePath = @"C:\absolute\path\to\file.cpp",
            }.ToCaptures();
        ...
        {
            CFamily.FileConfig.ConvertCompileAs("Default").Should().Be("");
            CFamily.FileConfig.ConvertCompileAs("CompileAsC").Should().Be("/TC");
            CFamily.FileConfig.ConvertCompileAs("CompileAsCpp").Should().Be("/TP");

            Action action = () => CFamily.FileConfig.ConvertCompileAs("foo");
